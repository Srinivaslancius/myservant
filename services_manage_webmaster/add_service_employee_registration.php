              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST" autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control" id="email" placeholder="Email" data-error="Please enter a valid email address." required>
                  ...
                  <div class="form-group">
                    ...
                    <select id="employee_belongs_to" name="employee_belongs_to" class="custom-select" data-error="This field is required." required>
                  ...
                  <div class="form-group">
                    ...
                    <select id="form-control-3" name="service_provider_registration_id" class="custom-select" data-error="This field is required.">
