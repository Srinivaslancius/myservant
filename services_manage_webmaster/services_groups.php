...
<?php $getGroupsData = getAllData('services_groups'); $i=1; ?>
              ...
              <table class="table table-striped table-bordered dataTable" id="table-1">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td> <a href="edit_services_groups.php?gid=<?php echo $row['id']; ?>"><i class="zmdi zmdi-edit"></i></a> &nbsp; <a href="delete_services_groups.php?gid=<?php echo $row['id']; ?>"><i class="zmdi zmdi-delete zmdi-hc-fw" onclick="return confirm('Are you sure you want to delete?')"></i></a> &nbsp;<a href="#"><i class="zmdi zmdi-eye zmdi-hc-fw" data-toggle="modal" data-target="#<?php echo $row['id']; ?>" class=""></i></a></td>
                     <!-- Open Modal Box  here -->
