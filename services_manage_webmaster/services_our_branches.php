...
<?php $getOurBranchesData = getAllData('services_our_branches'); $i=1; ?>
              ...
              <table class="table table-striped table-bordered dataTable" id="table-1">
                ...
                <tbody>
                  ...
                  <tr>
                   ...
                   <td> <a href="edit_services_our_branches.php?branchid=<?php echo $row['id']; ?>"><i class="zmdi zmdi-edit"></i></a> &nbsp; <a href="delete_services_our_branches.php?branchid=<?php echo $row['id']; ?>"><i class="zmdi zmdi-delete zmdi-hc-fw" onclick="return confirm('Are you sure you want to delete?')"></i></a></td>
                  </tr>
                  <?php  $i++; } ?>
                </tbody>
              </table>
