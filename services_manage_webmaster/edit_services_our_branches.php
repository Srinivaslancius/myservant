              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST" autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="address" class="form-control" id="form-control-2" placeholder="Address" data-error="Please enter address." required value="<?php echo $getOurBranchesData['address'];?>">
                    <div class="help-block with-errors"></div>
                  </div>
