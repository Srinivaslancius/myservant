              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control" id="email" placeholder="email" data-error="Please enter Valid Email Address" onkeyup="checkEmail()" required>
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" name="email_id" class="form-control service_provider_business" id="email" placeholder="email" data-error="Please enter Valid Email Address" onkeyup="checkEmail()">
                    <span id="email_status" style="color: red;"></span>
                    <div class="help-block with-errors"></div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="associate_or_not" class="form-control service_provider_business" id="form-control-2" placeholder="Associate or Not" data-error="Please enter Associate or Not">
                    <div class="help-block with-errors"></div>
                  </div>
                  </div>
