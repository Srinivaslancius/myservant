...
<div id="top_line">
			<div class="container-fluid">
				<div class="row">
					...
					<ul id="top_links">
					 <li><span class="icon-location" data-toggle="popover" data-placement="bottom" data-content="TOP SEARCHED: <br> Vijayawda, Hyderabad, Karimnagar, Chennai, Warangal, Pune, Bangalore">Vijayawda</span></li>
					 <li><form>
