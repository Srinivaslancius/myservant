						...
						<form method="post" action="" id="contactform" name="form"> 
							...
							<div class="row">
								...
								<div class="col-md-6 col-sm-6">
									<div class="form-group">
										<label>Phone</label>
										<input type="number" id="phone_contact" name="phone_contact" class="form-control valid_mobile_num" placeholder="Enter Phone number" maxlength="10" pattern="[0-9]{10}" required>
									</div>
								</div>
							</div>
							<div class="row">
