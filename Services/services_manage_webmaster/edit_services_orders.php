...
if (!isset($_POST['submit'])) {
  ...
  $sql = "UPDATE `services_orders` SET assign_service_provider_id = '$assign_service_provider_id',order_price = '$order_price',order_total = '$order_total',lkp_order_status_id='$lkp_order_status_id', lkp_payment_status_id='$lkp_payment_status_id', delivery_date ='$delivery_date' WHERE id = '$order_id' AND sub_category_id = '$subcat_id'";
              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST" autocomplete="off" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <select name="assign_service_provider_id" class="custom-select" disabled data-error="This field is required." required>
...
<?php include_once 'admin_includes/footer.php'; ?><?php include_once 'admin_includes/main_header.php'; ?>
<?php  
error_reporting(0);
$id = $_GET['order_id'];
if (!isset($_POST['submit'])) {
    ...
    $lkp_status_id = $_POST['lkp_status_id'];
      ...
      $sql = "UPDATE `services_orders` SET lkp_status_id='$lkp_status_id' WHERE id = '$id' ";
      if($conn->query($sql) === TRUE){
         echo "<script type='text/javascript'>window.location='services_orders.php?msg=success'</script>";
      } else {
         echo "<script type='text/javascript'>window.location='services_orders.php?msg=fail'</script>";
...
?>
      <div class="site-content">
        <div class="panel panel-default">
          ...
          <div class="panel-body">            
            <div class="row">
              <?php $getOrders = getAllDataWhere('services_orders','id',$id);
              $getOrdersData = $getOrders->fetch_assoc(); ?>   
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form autocomplete="off" data-toggle="validator" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <select id="form-control-3" name="lkp_status_id" class="custom-select" data-error="This field is required." required>
                      ...
                      <?php while($row = $getStatus->fetch_assoc()) {  ?>
                          <option <?php if($row['id'] == $getOrdersData['lkp_status_id']) { echo "Selected"; } ?> value="<?php echo $row['id']; ?>"><?php echo $row['status']; ?></option>
                      <?php } ?>
                    </select>
                    <div class="help-block with-errors"></div>
                  </div>
