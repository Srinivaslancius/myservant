...
<?php $getServiceTodayOrders = "SELECT * FROM services_orders WHERE DATE(`delivery_date`) = CURDATE() AND lkp_order_status_id != 3 AND lkp_payment_status_id != 3 ORDER BY lkp_order_status_id DESC ";
