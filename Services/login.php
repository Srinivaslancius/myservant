                	...
                	<div id="login">
                           ...
                           <form autocomplete="off" method="post" action="mobile_otp.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="user_mobile" id="user_mobile" class=" form-control valid_mobile_num"  placeholder="Mobile Number" maxlength="10" pattern="[0-9]{10}" onkeyup="checkMobile();" required>
